...
do_install() {
	...
	ln -sf ${base_libdir}/firmware/component_7105_mb680.fw   ${D}${base_libdir}/firmware/component.fw
	ln -sf ${base_libdir}/firmware/component_7105_hdk7105.fw ${D}${base_libdir}/firmware/component_7105_pdk7105.fw
}
