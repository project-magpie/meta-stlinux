...
RRECOMMENDS_${PN}_spark7162 += "kernel-module-uinput"
RRECOMMENDS_${PN}_ufs922 += "kernel-module-uinput"
RRECOMMENDS_${PN}_ufc960 += "kernel-module-uinput"

PR = "${INCPR}.0"

EXTRA_OECONF += "--with-kerneldir=${STAGING_KERNEL_DIR} ${DRIVER}"
EXTRA_OECONF_spark += "--without-x --with-driver=userspace"
EXTRA_OECONF_spark7162 += "--without-x --with-driver=userspace"
EXTRA_OECONF_ufs922 += "--without-x --with-driver=userspace"
EXTRA_OECONF_ufc960 += "--without-x --with-driver=userspace"
...
LIRC_SPARK_PATCHES = " file://lirc-0.9.0-neutrino-uinput-hack.diff;patch=1 \
...
"
SRC_URI_append_spark += "${LIRC_SPARK_PATCHES}"
SRC_URI_append_spark7162 += "${LIRC_SPARK_PATCHES}"
SRC_URI_append_ufs922 += "${LIRC_SPARK_PATCHES}"
SRC_URI_append_ufc960 += "${LIRC_SPARK_PATCHES}"
